...
describe('GetCoupons', () => {
  it('should return a array of object which is not empty', () => {
...
describe('calculateDiscount', () => {
  it('should return discounted price given valid code ', () => {
...
describe('validateUserInput', () => {
  ...
  it('should return an error if username is less than 3 characters', () => {
    expect(validateUserInput('m', 42)).toMatch(/invalid/i);
  });
  ...
  it('should return an error if age is not a number', () => {
    expect(validateUserInput('nahid', '42')).toMatch(/invalid/i);
  });
  it('should return an error if age is less than 18', () => {
    expect(validateUserInput('nahid', 17)).toMatch(/invalid/i);
  });
  it('should return an error if age is greater than 100', () => {
    expect(validateUserInput('nahid', 101)).toMatch(/invalid/i);
  });
